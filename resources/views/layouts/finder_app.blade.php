  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="../../index3.html" class="brand-link">
        <img src="{{asset('dist/img/logo.png')}}" alt="FINDER" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">FINDER</span>
      </a>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2021-2022 <a href="https://finder.bh">Finder</a>.</strong> All rights reserved.
    </footer>
