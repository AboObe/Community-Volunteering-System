  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ route('qualifications.index') }}" class="nav-link">Qualification</a>
        </li>
        @endrole
        <li class="nav-item d-none d-sm-inline-block">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ route('announcements.index') }}" class="nav-link">Announcement</a>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="../../index3.html" class="brand-link">
        <img src="{{asset('dist/img/logo.png')}}" alt="Community Volunteering" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Community Volunteering</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="{{route('users.show',Auth::user()->id)}}" class="d-block">My Profile</a>
          </div>
        </div>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2021-2022 <a href="#">Community Volunteering</a>.</strong> All rights reserved.
    </footer>
